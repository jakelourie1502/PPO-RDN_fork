...
import mpi_util
import tf_util
from cmd_util import make_atari_env, arg_parser, make_lake_env
...
def train(*, env_id, num_env, hps, num_timesteps, seed):
    ...
    venv = VecFrameStack(make_lake_env(num_env, seed),nstack=2)
...
def main():
    ...
    parser.add_argument('--filename', type=str, default=str("1"))
    parser.add_argument('--num-timesteps', type=int, default=int(1000 * 1000))
    parser.add_argument('--num_env', type=int, default=8)
    parser.add_argument('--use_news', type=int, default=0)
    parser.add_argument('--gamma', type=float, default=0.99)
    parser.add_argument('--gamma_ext', type=float, default=0.9)
    ...
    print('int coeff: ', args.int_coeff)
    print('ext coeff: ', args.ext_coeff)
    sys.stdout =   open(f"TestResults/output_{str(args.filename)}.txt","w")
